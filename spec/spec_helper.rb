...
##
require_relative '../lib/BrotherFaxMessage'
require_relative '../lib/FaxMessage'
require_relative '../lib/magick/utils'
...
RSpec.configure do |config|
  ...
  raise "SPEC File decrypt pass(key) should be exists( export SPEC_ENC_KEY=your_pass )" unless ENV['SPEC_ENC_KEY']
  $pass = ENV['SPEC_ENC_KEY']
  ## decrypt privacy files
  decrypt_files_in_repository if $pass
  ## load env
